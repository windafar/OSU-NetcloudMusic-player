...
namespace TextCodec
{
    ...
    //    {
    //        Microshaoft.Text.IdentifyEncoding sinodetector;
    //        string result = null;

    //        argc = new string[1];
    //        //argc[0] = "c:\\chinesedata\\codeconvert\\voaunit.txt";

    //        argc[0] = "http://china5.nikkeibp.co.jp/china/news/com/200307/pr_com200307170131.html";

    //        sinodetector = new Microshaoft.Text.IdentifyEncoding();
    //        if (argc[0].StartsWith("http://") == true)

    //        {
    //            try
    //            {
    //                result = sinodetector.GetEncodingName(new System.Uri(argc[0]));
    //            }
    //            catch (System.Exception e)
    //            {
    //                System.Console.Error.WriteLine("Bad URL " + e.ToString());
    //            }
    //        }
    //        else
    //        {
    ...
    //        }
    //      //读文件
    //      StreamReader reader = new StreamReader(filePath, sinodetector.GetEncoding(sinodetector.GetEncodingName(filePath));//后面可根据文件路径获取文件编码
        ...
        internal static string[] nicename = new string[]
   {
    ...
    /// <summary>
    /// 该类包含以前的Encode类，用于转换器中。使用该类主要是为了速度/准确率的测试
    /// </summary>
